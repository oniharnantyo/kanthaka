            ...
            <div class="row">
              <div class="col-2">
                <a href="/" class="navbar-brand align-middle">
                  <img src="https://pbs.twimg.com/profile_images/248185979/logo_Vidyasena.bmp" alt=""
                    style="height :50px;">
                </a>
              </div>
          ...
          <div class="col-8 col-md-8 main-menu">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a id="tentang-kami" class="nav-link cursor-pointer" href="{{URL::to('tentang-kami')}}">Tentang
                    Kami</a></li>
                <li><a id="program-kerja" class="nav-link cursor-pointer" href="{{URL::to('program-kerja')}}">Program
                    Kerja</a></li>
      ...
      <div class="container">
        <div class="row mb-5 text-left border-bottom">
          <div class="mb-5 col-md-4 px-4">
            <a href="">
              <img height="100px" src="https://pbs.twimg.com/profile_images/248185979/logo_Vidyasena.bmp" alt=""
                class="mb-4">
            </a>
            <p class="font-italic" style="font-size: 12px;">"Biarlah mengorbankan harta demi menyelamatkan anggota
              tubuh,
