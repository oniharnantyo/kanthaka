  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="row mb-2 mr-0 float-right">
        <a href="/portal/blogs/create" class="btn btn-primary">
      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="blogs-list" width="100%" cellspacing="0">
    ...
    $('#blogs-list').dataTable({
        ...
        columnDefs: [
          ...
          },
          {
            targets : 1,
            render: function (data) {
                return '<a href="/portal/blogs/' + data + '">' + data + '</a>';
            }
          },
          {
            targets : 4,
        ...
        if (result) {
          $.ajax({
            ...
            success: function(data, status, xhr) {
              $('#blogs-list').DataTable().ajax.reload();
